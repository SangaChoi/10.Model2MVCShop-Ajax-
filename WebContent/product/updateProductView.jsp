		...
		$.ajax(
				{
					...
					success : function(JSONData , status) {
								...
								if( JSONData != null ){
									...
									$(window.parent.frames["rightFrame"].document.location).attr("href","/product/getProduct?prodNo="+prodNo+"&menu=manage");
		...
		<td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;" data-param1="${product.prodNo}">
